...
function Home() {
  ...
  return (
    <div className='Home'>
      ...
      <Divider style={{ color: '#f5a507', fontSize: '33px', marginTop: '3rem', marginBottom: '3rem' }}>Chứng nhận chất lượng</Divider>
      ...
      <Divider style={{ color: '#f5a507', fontSize: '33px', marginTop: '3rem', marginBottom: '3rem' }}>Sản phẩm nổi bật</Divider>
      <Swiper
        spaceBetween={0}
        slidesPerView={1}
        loop={true}
      ...
      >
        {products.length && products.map(item => {
          return <SwiperSlide><div className='swiper-slide-top-product'><img src={`${item.image}`}></img></div></SwiperSlide>
        })}
      </Swiper>
    </div>
  )
