...
function ManageInvoice() {
  ...
  const printModalElementId = useRef(`print-id-${Date.now()}`);
  ...
  const handlePrintInvoice = () => {
    print(printModalElementId.current, 'html')
  ...
  return (
    <div className="ManageInvoice">
      ...
      <Modal
        title=""
        className={printModalElementId.current}
        open={isOpen}
      ...
      >
        <div id={printModalElementId.current}>
